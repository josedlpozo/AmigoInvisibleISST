...
<body>
            ...
            <header>
                <div class="container">
                    ...
                    <form action="interfazmicuenta.html">   
                            ...
                            <h1>Acceso a miembros</h1>
                                <fieldset>
                                    ...
                                    <div class='rellenar'>
                                        ...
                                        <div class="clear"></div>
                                        <input class="input" id="email" name="email" type="email" maxlength="256" value="" required>
                                        <div class="clear"></div>
                                        <label for="password">Contraseña</label>
                                        <div class="clear"></div>
                                        <input class="input" id="password" name="password" type="password" maxlength="18" required>
                                    ...
                                    <div id='submit' class='outerDiv' align="center">
                                        <input align="center" type="submit" value="Login" class="btn btn-default" style="background-color: #2c3e50"/>             
                                    </div>
                                <br>
                                <div id='submit' class='outerDiv' align="center">
                                        <input align="center" type="submit" value="Login" class="btn btn-default" style="background-color: #2c3e50"/>             
                                 </div>
                                <b><a id='entrar' class='entrar' href="/account/forgot-password">¿Olvido su contraseña?</a> </b>
                                <br>
                                <b><a id='entrar' class='entrar' href="interfazregistro.html">Crear una cuenta</a> </b>
