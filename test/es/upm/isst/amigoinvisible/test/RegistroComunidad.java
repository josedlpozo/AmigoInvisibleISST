...
public class RegistroComunidad {
  ...
  public void testRegistroComunidad() throws Exception {
    ...
    driver.findElement(By.cssSelector("div.row.text-center > input.btn.btn-default")).click();
    driver.findElement(By.name("nombre_comunidad")).clear();
    driver.findElement(By.name("nombre_comunidad")).sendKeys("comunidad");
    ...
    driver.findElement(By.cssSelector("li.page-scroll,.active > a")).click();
